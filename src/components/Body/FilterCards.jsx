...
function FilterCards() {
  return (
    <section className="flex flex-col gap-4 w-full bg-[#F5F4F0] md:py-8 max-md:py-4 px-[10%]">
      <div className="flex flex-col md:gap-2 max-md:items-center md:pr-[11%] max-md:px-4 ">
