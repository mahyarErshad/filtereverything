  ...
  return (
    <section className="flex justify-center items-center py-28 bg-purple max-md:gap-6 md:gap-8 lg:gap-16 max-md:flex-col px-4">
      ...
      <div className="flex justify-center items-center flex-wrap gap-4">
        ...
        <Button href="https://www.zhaket.com/web/filter-everything-filter-plugin" title="نسخه حرفه ای" className="hover:bg-[#18caca] font-bold py-[1.05rem] max-md:px-[3.2rem] md:px-[2rem] custom-border max-sm:w-[21rem]" />
      </div>
    </section>
  );
}
