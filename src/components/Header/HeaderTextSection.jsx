...
function HeaderTextSection() {
  return (
    <div className="md:pr-[5%] sm:pr-10 max-sm:pr-8 max-lg:bg-[#435ec3b9] pb-6 rounded-bl-[50%]">
      ...
      <div className="flex justify-between items-center flex-wrap mt-6 max-md:w-[16.5rem] md:w-[29rem] max-md:gap-4 md:gap-2">
        <Button title="دانلود رایگان" className="download-for-free-button py-2" backgroundColor="bg-transparent" textColor="text-white" />
        <Button title="خرید نسخه حرفه ای" className="hover:bg-[#18caca] font-bold py-[1.05rem] max-md:px-[3.2rem] md:px-[2rem] md:w-56" />
      </div>
    </div>
  );
}
