...
function FilterCards() {
  return (
    <section className="flex flex-col gap-4 w-full bg-[#F5F4F0] md:py-8 max-md:py-4 px-4 lg:pr-[10%]">
      <div className="flex flex-col md:gap-2 max-md:items-center max-lg:px-4 lg:pr-[11%] ">
