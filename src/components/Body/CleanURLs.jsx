...
function CleanURLs() {
  return (
    <section className="flex flex-col gap-4 w-full bg-[#F4F9FA] md:py-36 max-md:py-4 px-2">
      <div className="flex flex-col md:gap-2 max-md:items-center md:px-[25%] max-md:px-4 mb-6">
      ...
      <img className="max-md:w-full md:w-3/4 self-center" src={clean_URLs} alt="card filter" />
    </section>
  );
}
