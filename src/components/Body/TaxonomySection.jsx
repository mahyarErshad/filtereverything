...
function TaxonomySection() {
  return (
    <section className="flex flex-nowrap gap-4 w-full px-4 max-md:flex-col">
      <div className="md:w-2/4 max-md:w-full flex bg-yellow-300 md:pt-20 flex-col max-lg:px-4 lg:px-[8%] justify-between md:pb-[6%] pt-[5%]">
        <div className="flex flex-col w-full gap-4 max-md:justify-center">
          ...
          <p className="lg:mr-[5%] max-sm:hidden">پس شما میتوانید</p>
      </div>
